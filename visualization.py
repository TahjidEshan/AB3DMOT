    ...
    for seq in seq_list:
        ...
        for count in range(start_count, num_images):
            ...
            labeldata = (Object3d(getstringfromarray(
                line[2:])) for line in filecontentframe)
            object_res = []
            object_res_det = []
            object_res_raw = []
...
if __name__ == "__main__":
    ...
    result_root = '/home/eshan//AB3DMOT/results'
    result_sha = sys.argv[1]
    results = ["car_3d_det_val", "ped_3d_det_val", "cyc_3d_det_val"]
    if 'val' in result_sha:
        data_root = '/media/eshan/OS/Users/Eshan//Documents/kitti_tracking/training'
    elif 'test' in result_sha:
        data_root = '/media/eshan/OS/Users/Eshan//Documents/kitti_tracking/testing'
    else:
        print("wrong split!")
        sys.exit(1)
